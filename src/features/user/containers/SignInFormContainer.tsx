...
import { CButton, CCard, CCardBody, CCol, CLabel, CRow } from '@coreui/react';
                ...
                >
                    {({ isValid }) => (
                        <Form>
                            ...
                            <CFormikInput id="email" name="email" type="text" />
                            <CLabel>{'Hasło'}</CLabel>
                            <CFormikInput id="password" name="password" type="password" />
                            <CRow>
                                <CCol xs="6">
                                    <CButton color="primary" className="px-4" type="submit" disabled={!isValid}>
                                        Zaloguj
                                    </CButton>
                                </CCol>
                            </CRow>
